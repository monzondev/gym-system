...
<body>
            ...
            <table class="table text-center table-striped table-hover" id="table_body">
                ...
                <tbody>
                    ...
                    <tr id="<?php echo $miembro['id_miembro']; ?>" class="filas">
                        <th style="padding-top: 5px; padding-bottom: 5px;" scope="row"><img
                                src="../recursos/fotografias/<?php echo $miembro['foto'] ?>" class="rounded-circle"
                                width="50" alt="<?php echo $miembro['usuario'] ?>"
                                title="<?php echo $miembro['usuario'] ?>"></th>
    ...
    <!-- Large modal -->
    <div class="modal fade bd-example-modal-lg" id="modalDatos" tabindex="-1" role="dialog"
                                        ...
                                        <div class="row .nav-tabs">
                                            <ul>
                                                <li style="display:inline;  padding-left:10px; padding-right:75px;">
                                                    <a class="opcion" id="link-personal" onclick="mostrarPersonal();">Personal</a>
                                                </li>
                                                <li style="display:inline; ">
                                                    <a class="opcion" id="link-gimnasio" onclick="mostrarExtra();">Gimnasio</a>
                                                </li>
