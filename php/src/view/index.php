    ...
    <div class="row">
        ...
        <div class="col-md-10" >
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                ...
                <li class="nav-item">
                    <a class="nav-link" id="tab-pagos-en-proceso" data-toggle="tab" href="#pagos-en-proceso" role="tab" aria-controls="pagos-en-proceso" aria-selected="false"><p>Pagos en Proceso</p></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="tab-miembros-inactivos" data-toggle="tab" href="#miembros-inactivos" role="tab" aria-controls="miembros-inactivos" aria-selected="false"><p>Miembros Inactivos</p></a>
                </li>
            </ul>
